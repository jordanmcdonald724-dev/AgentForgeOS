...
class BridgeServer:
    ...
    def __init__(self, bridge_root: str | None = None) -> None:
        ...
        self.unreal_config: dict[str, Any] = {
    ...
    async def launch_unity_editor(self, project_path: str, additional_args: list[str] | None = None) -> dict[str, Any]:
        """
    ...
    async def launch_unreal_editor(self, project_path: str, additional_args: list[str] | None = None) -> dict[str, Any]:
        """
    ...
    async def build_unity_project(self, project_path: str, build_target: str = "StandaloneWindows64", output_path: str | None = None) -> dict[str, Any]:
        """
    ...
    async def build_unreal_project(self, project_path: str, build_target: str = "Win64", output_path: str | None = None) -> dict[str, Any]:
        """
    ...
    def _get_unity_version(self) -> str | None:
    ...
    def _get_unreal_version(self) -> str | None:
