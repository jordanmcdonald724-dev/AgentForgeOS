...
- Present: `apps/` with module placeholders `studio/`, `builds/`, `research/`, `assets/`, `deployment/` and top-level `apps/README.md`.
...
- Compliance checklist stored in `docs/legacy/phases/PHASE10_COMPLIANCE.md`.
- Validation commands:
