# DEPRECATED — V2 Runtime Reliability & Live Preview

This document is deprecated and must not be used as a specification.

Canonical spec: [master_build_guideline.md](file:///d:/AgentForgeOS/docs/master_build_guideline.md)
